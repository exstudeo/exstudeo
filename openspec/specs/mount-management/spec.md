...
Persistent management of File System Access API directory handles. Users can add, mount, unmount, and remove directory mounts. All entries are persisted in IndexedDB and automatically restored on app load.
