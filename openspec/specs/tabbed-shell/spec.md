...
A URL-driven tabbed layout using React Router and shadcn `Tabs`. Provides the app skeleton with a tab bar, content panel, and client-side navigation. Tabs are backed by routes so deep-linking works out of the box.
